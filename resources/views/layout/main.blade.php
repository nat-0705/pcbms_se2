        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('dashboard')}}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img class="img-profile rounded-circle" src="assets/img/VSU_Seal_2022.png" style="width:36px;height:36px;">
                </div>
                <div class="sidebar-brand-text mx-3">PCBMS</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseReport" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item" href="{{ url('days') }}">Days Report</a>
                        ...
                        <a class="collapse-item" href="{{ url('receipts') }}">Receipts</a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - Customers Information -->
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <!-- Dropdown - Customers Information -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; PCBMS 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
